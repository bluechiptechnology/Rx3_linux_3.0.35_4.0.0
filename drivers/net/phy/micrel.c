...
// back-ported from v3.8.8 drivers/net/phy/phy_device.c
static int phy_drivers_register(struct phy_driver *new_driver, int n)
{
	int i, ret = 0;
...
// back-ported from v3.8.8 drivers/net/phy/phy_device.c
static void phy_drivers_unregister(struct phy_driver *drv, int n)
{
	int i;
	for (i = 0; i < n; i++) {
